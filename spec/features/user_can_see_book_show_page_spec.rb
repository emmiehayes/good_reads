...
describe 'as a user visiting book_path' do
  it 'can see a single book' do
    ...
    # I also see a rating that each user gave the book as part of their review. # (rating will be a number between 1 and 5)
    # I see the average rating for that book. # (e.g "Average Rating: 3.5")
